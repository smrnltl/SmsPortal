...
namespace sc.web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return await this.UserManager.FindByIdAsync(User.Identity.GetUserId());
        }
        ...
        public async Task<ActionResult> UpdateUser(UpdateViewModel createUserModel)
        {
            ...
            var isValidPwd = UserManager.CheckPassword(user, createUserModel.Password);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                EmailHelper.SendEmail("Online Policy System: Password Recovery", "Reset password with this link <a href=\"" + callbackUrl + "\">here</a>", null, "", "", true, model.Email);
